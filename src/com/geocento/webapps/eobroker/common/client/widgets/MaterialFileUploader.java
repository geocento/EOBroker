    ...
    private native void initDropzone(Element e, Element template, String previews, Element uploadPreview, Element uploadedFiles, String url, int maxFileSize, int maxFiles, String method, boolean autoQueue, String acceptedFiles, String clickable,boolean preview,boolean withCredentials) /*-{
        ...
        $wnd.jQuery(document).ready(function() {
            ...
            zdrop.on('drop', function () {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireDropEvent()();
                if(preview) {
            ...
            zdrop.on('dragstart', function () {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireDragStartEvent()();
            });

            zdrop.on('dragend', function () {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireDragEndEvent()();
            });

            zdrop.on('dragenter', function () {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireDragEnterEvent()();
                if(preview){
            ...
            zdrop.on('dragover', function () {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireDragOverEvent()();
            });

            zdrop.on('dragleave', function () {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireDragLeaveEvent()();
                if(preview) {
                    $wnd.jQuery(e).removeClass("active");
                }
            });
            ...
            zdrop.on("addedfile", function(file) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireAddedFileEvent(*)(file.name , file.lastModifiedDate , file.size , file.type);
                totalFiles += 1;
            ...
            zdrop.on("removedfile", function(file) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireRemovedFileEvent(*)(file.name , file.lastModifiedDate , file.size , file.type);
                totalFiles -= 1;
                $wnd.jQuery(uploadedFiles).html('Uploaded files ' + totalFiles);
            });
            ...
            zdrop.on('error', function (file, response) {
                ...
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireErrorEvent(*)(file.name , file.lastModifiedDate , file.size , file.type, code, response);
            });

            zdrop.on("totaluploadprogress", function (progress) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireTotalUploadProgressEvent(*)(progress);
            ...
            zdrop.on('sending', function (file, xhr, formData) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::addFormParameters(*)(formData);
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireSendingEvent(*)(file.name , file.lastModifiedDate , file.size , file.type, file.xhr.status, file.xhr.statusText);
            });

            zdrop.on('success', function (file, response) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireSuccessEvent(*)(file.name , file.lastModifiedDate , file.size , file.type, file.xhr.status, response);
            });

            zdrop.on('complete', function (file) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireCompleteEvent(*)(file.name , file.lastModifiedDate , file.size , file.type, file.xhr.status, file.xhr.statusText);
            });

            zdrop.on('canceled', function (file) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireCancelEvent(*)(file.name , file.lastModifiedDate , file.size , file.type);
            });

            zdrop.on('maxfilesreached', function (file) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireMaxFilesReachEvent(*)(file.name , file.lastModifiedDate , file.size , file.type);
            });

            zdrop.on('maxfilesexceeded', function(file) {
                that.@com.geocento.webapps.eobroker.common.client.widgets.MaterialFileUploader::fireMaxFilesExceededEvent(*)(file.name , file.lastModifiedDate , file.size , file.type);
