...
public class EventHelper {
    ...
    public static void createAndPropagateCompanyEvent(EntityManager em, Company company, Category category, Event.TYPE type, String message, String linkId) {
    ...
    public static void createAndPropagateProductEvent(EntityManager em, Product product, Company company, Category category, Event.TYPE type, String message, String linkId) {
        Event event = new Event();
        event.setCategory(category);
        event.setCompany(company);
        event.setMessage(message);
        ...
        // now propagate
        // look for followers
        TypedQuery<Following> query = em.createQuery("select f from Following f where f.product = :product", Following.class);
