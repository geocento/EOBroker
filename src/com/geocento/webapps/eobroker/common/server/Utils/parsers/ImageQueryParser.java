...
public class ImageQueryParser extends Parser {
	...
	public ImageQueryParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class RContext extends ParserRuleContext {
		public List<TerminalNode> INT() { return getTokens(ImageQueryParser.INT); }
		public TerminalNode INT(int i) {
			return getToken(ImageQueryParser.INT, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ImageQueryListener ) ((ImageQueryListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ImageQueryListener ) ((ImageQueryListener)listener).exitR(this);
		}
	}
	...
	public static final String _serializedATN =
		"\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\16\13\4\2\t\2\3\2"+
		"\7\2\6\n\2\f\2\16\2\t\13\2\3\2\2\2\3\2\2\2\n\2\7\3\2\2\2\4\6\7\3\2\2\5"+
